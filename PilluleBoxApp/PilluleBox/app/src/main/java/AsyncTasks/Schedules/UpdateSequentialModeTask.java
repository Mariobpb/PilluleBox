...
public class UpdateSequentialModeTask extends AsyncTask<Void, Void, Boolean> {
    private static final String TAG = "UpdateSequentialModeTask";
    ...
    public UpdateSequentialModeTask(Context context, String token, String macAddress,
                                    SequentialMode sequentialMode, UpdateCallback callback) {
    ...
    protected Boolean doInBackground(Void... voids) {
        try {
            URL url = new URL(GeneralInfo.getURL() + "update_sequential_mode/" + macAddress);
            ...
            jsonBody.put("id", sequentialMode.getId());
            ...
            Log.e(TAG, "Error updating sequential mode: " + e.getMessage(), e);
